...
public final class IdentityDtos {
    ...
    /** Org-directory entry for pickers (assign lead, chat, tasks). No roles/status/PII beyond name+email. */
    public record LiteUserItem(UUID id, String displayName, String email) {}
