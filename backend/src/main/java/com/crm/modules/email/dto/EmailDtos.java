...
public final class EmailDtos {
    ...
    public record CreateAccountRequest(String provider, @NotBlank @jakarta.validation.constraints.Email String email,
                                       @Size(max = 120) String displayName, @jakarta.validation.constraints.Email @Size(max = 255) String replyTo,
                                       @Size(max = 255) String smtpHost,
                                       Integer smtpPort, String smtpEncryption, String smtpUsername, String smtpPassword,
                                       Integer dailyLimit) {}

    public record AccountItem(UUID id, String provider, String email, String displayName, String replyTo, String smtpHost,
                              Integer smtpPort, String smtpEncryption, String status, Instant verifiedAt,
                              int dailyLimit, UUID userId, Instant createdAt) {}

    public record TestSendRequest(@NotBlank @jakarta.validation.constraints.Email String to) {}
