...
const FIELD_NAMES: Record<string, string> = {
  stageId: 'Stage', stage: 'Stage', status: 'Status', assignedUserId: 'Assigned to', userId: 'User',
  ownerId: 'Owner', clientId: 'Client', dealId: 'Deal', pipelineId: 'Pipeline', companyId: 'Company',
  score: 'Score', businessName: 'Business name', email: 'Email', phone: 'Phone',
}

/** IPv6/IPv4 loopback and private addresses shown human-readable; real IPs never altered. */
function formatIp(ip: string): string {
  if (!ip) return ''
  if (ip === '::1' || ip === '0:0:0:0:0:0:0:1') return 'localhost (::1)'
