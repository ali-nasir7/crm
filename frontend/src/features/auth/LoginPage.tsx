    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden flex-1 flex-col justify-between overflow-hidden bg-slate-900 p-10 lg:flex">
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-3xl font-extrabold leading-tight text-white">
            Turn conversations into <span className="text-blue-400">opportunities.</span>
          </h1>
          <p className="mt-4 text-slate-400">
            Track every lead, nail every follow-up, and close faster - pipeline, calling, email, scoring, and automation in one clean system.
          </p>
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-6">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-10 text-center text-[11px] text-slate-400">Built by Ali Nasir</p>
